...
object SettingsMigration {
    ...
    internal val RESETTABLE_PREFERENCE_KEYS = setOf(
        ...
        C.LIVE_NOTIFICATION_RICH_CONTENT,
        C.LIVE_NOTIFICATION_SHOW_PREVIEW,
        C.LIVE_NOTIFICATION_SHOW_AVATAR,
        C.LIVE_NOTIFICATION_SHOW_TITLE,
        C.LIVE_NOTIFICATION_SHOW_CATEGORY,
        C.LIVE_NOTIFICATION_SHOW_VIEWERS,
        C.LIVE_NOTIFICATION_PREVIEW_METERED,
        C.LIVE_NOTIFICATION_WATCH_ACTION,
        ...
        C.SYSTEM_MEDIA_SHOW_GO_LIVE,
        C.PREDICTION_TRACKING_ENABLED,
        C.PREDICTION_AUTO_TRACK_AFTER_VOTE,
        C.PREDICTION_REQUEST_PROMOTED,
        C.PREDICTION_NOTIFY_RESOLVED,
        C.PREDICTION_STATUS_CHIP_TEXT,
        C.DROPS_TRACKING_ENABLED,
        C.DROPS_AUTO_TRACK_ACTIVE,
        C.DROPS_REQUEST_PROMOTED,
        C.DROPS_NOTIFY_COMPLETED,
        C.DROPS_STATUS_CHIP_TEXT,
        C.CHAT_BUBBLE_ENABLED,
        C.CHAT_BUBBLE_AUTO_EXPAND,
        C.CHAT_BUBBLE_SHOW_UNREAD,
        C.CHAT_BUBBLE_SHOW_PREVIEW,
        C.CHAT_BUBBLE_KEEP_OPEN,
        C.PREDICTION_LIVE_UPDATE_SNAPSHOT,
        C.PREDICTION_LIVE_UPDATE_RESULT_ID,
        C.DROPS_LIVE_UPDATE_SNAPSHOT,
        C.DROPS_LIVE_UPDATE_RESULT_ID,
        ...
        C.CHAT_PREDICTIONS_RESULT_DURATION,
