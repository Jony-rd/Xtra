...
object C {
    ...
    const val PLAYER_HUD_LAYOUT_V2 = "player_hud_layout_v2"
    ...
    const val UI_USER_CARD_SHOW_ACCOUNT_CREATED = "ui_user_card_show_account_created"
    const val UI_USER_CARD_SHOW_FOLLOWED_SINCE = "ui_user_card_show_followed_since"
    const val UI_USER_CARD_SHOW_SUBSCRIPTION = "ui_user_card_show_subscription"
    const val UI_USER_CARD_SHOW_ROLES = "ui_user_card_show_roles"
    const val UI_USER_CARD_SHOW_LAST_BROADCAST = "ui_user_card_show_last_broadcast"
    ...
    const val PHONE_CHAT_OVERLAY_ENABLED = "phone_chat_overlay_enabled"
    const val PHONE_CHAT_OVERLAY_X_PERCENT = "phone_chat_overlay_x_percent"
    const val PHONE_CHAT_OVERLAY_Y_PERCENT = "phone_chat_overlay_y_percent"
    const val PHONE_CHAT_OVERLAY_WIDTH_PERCENT = "phone_chat_overlay_width_percent"
    const val PHONE_CHAT_OVERLAY_HEIGHT_PERCENT = "phone_chat_overlay_height_percent"
    const val PHONE_CHAT_OVERLAY_OPACITY = "phone_chat_overlay_opacity"
    ...
    const val PLAYER_SWIPE_EDGE_WIDTH_PERCENT = "player_swipe_edge_width_percent"
    const val PLAYER_SWIPE_SPEED_ZONE_HEIGHT_PERCENT = "player_swipe_speed_zone_height_percent"
    const val PLAYER_SWIPE_BRIGHTNESS_SENSITIVITY = "player_swipe_brightness_sensitivity"
    const val PLAYER_SWIPE_VOLUME_SENSITIVITY = "player_swipe_volume_sensitivity"
    const val PLAYER_SWIPE_SPEED_SENSITIVITY = "player_swipe_speed_sensitivity"
    const val PLAYER_SWIPE_SPEED_STEP = "player_swipe_speed_step"
    const val PLAYER_SWIPE_IGNORE_WHEN_LOCKED = "player_swipe_ignore_when_locked"
    ...
    const val PLAYER_LIVE_REWIND_TIME_SIDE = "player_live_rewind_time_side"
    ...
    const val CHAT_BACKGROUND_ENABLED = "chat_background_enabled"
    const val CHAT_BACKGROUND_URI = "chat_background_uri"
    const val CHAT_BACKGROUND_VISIBILITY = "chat_background_visibility"
    const val CHAT_MESSAGE_TEXT_COLOR = "chat_message_text_color"
    const val CHAT_METADATA_TEXT_COLOR = "chat_metadata_text_color"
    const val APP_BACKGROUND_ENABLED = "app_background_enabled"
    const val APP_BACKGROUND_URI = "app_background_uri"
    const val APP_BACKGROUND_VISIBILITY = "app_background_visibility"
    const val PLAYER_BACKGROUND_MODE = "player_background_mode"
    const val PLAYER_BACKGROUND_URI = "player_background_uri"
    const val PLAYER_BACKGROUND_VISIBILITY = "player_background_visibility"
    const val PLAYER_MESSAGE_TEXT_COLOR = "player_message_text_color"
    ...
    const val LIVE_NOTIFICATION_LAST_OWNER_HEARTBEAT = "live_notification_last_owner_heartbeat"
    const val LIVE_NOTIFICATION_LAST_WATCHDOG = "live_notification_last_watchdog"
    const val LIVE_NOTIFICATION_LAST_WATCHDOG_ACTION = "live_notification_last_watchdog_action"
    ...
    const val WATCH_STREAK_PROTECTION_ENABLED = "watch_streak_protection_enabled"
    const val WATCH_STREAK_MINIMUM = "watch_streak_minimum"
    const val WATCH_STREAK_INITIALIZED = "watch_streak_initialized"
    const val WATCH_STREAK_OBSERVED_IDS = "watch_streak_observed_ids"
    const val WATCH_STREAK_STATE_ACCOUNT_ID = "watch_streak_state_account_id"
    const val LIVE_NOTIFICATION_RICH_CONTENT = "live_notification_rich_content"
    const val LIVE_NOTIFICATION_SHOW_PREVIEW = "live_notification_show_preview"
    const val LIVE_NOTIFICATION_SHOW_AVATAR = "live_notification_show_avatar"
    const val LIVE_NOTIFICATION_SHOW_TITLE = "live_notification_show_title"
    const val LIVE_NOTIFICATION_SHOW_CATEGORY = "live_notification_show_category"
    const val LIVE_NOTIFICATION_SHOW_VIEWERS = "live_notification_show_viewers"
    const val LIVE_NOTIFICATION_PREVIEW_METERED = "live_notification_preview_metered"
    const val LIVE_NOTIFICATION_WATCH_ACTION = "live_notification_watch_action"
    const val LIVE_NOTIFICATION_CHAT_ACTION = "live_notification_chat_action"
    const val LIVE_UPDATE_TRACKING_NOTIFICATION_SETTINGS = "live_update_tracking_notification_settings"
    ...
    const val SYSTEM_MEDIA_SHOW_GO_LIVE = "system_media_show_go_live"
    const val SYSTEM_MEDIA_ARTWORK_STREAMER_AVATAR = "streamer_avatar"
    const val SYSTEM_MEDIA_ARTWORK_STREAM_PREVIEW = "stream_preview"
    const val SYSTEM_MEDIA_ARTWORK_CATEGORY = "category"
    const val SYSTEM_MEDIA_ARTWORK_NONE = "none"
    const val PREDICTION_TRACKING_ENABLED = "prediction_tracking_enabled"
    const val PREDICTION_AUTO_TRACK_AFTER_VOTE = "prediction_auto_track_after_vote"
    const val PREDICTION_REQUEST_PROMOTED = "prediction_request_promoted"
    const val PREDICTION_NOTIFY_RESOLVED = "prediction_notify_resolved"
    const val PREDICTION_STATUS_CHIP_TEXT = "prediction_status_chip_text"
    const val PREDICTION_CHIP_TIME_REMAINING = "time_remaining"
    const val PREDICTION_CHIP_MY_PICK = "my_pick"
    const val PREDICTION_CHIP_PREDICTION = "prediction"
    const val DROPS_TRACKING_ENABLED = "drops_tracking_enabled"
    const val DROPS_AUTO_TRACK_ACTIVE = "drops_auto_track_active"
    const val DROPS_REQUEST_PROMOTED = "drops_request_promoted"
    const val DROPS_NOTIFY_COMPLETED = "drops_notify_completed"
    const val DROPS_STATUS_CHIP_TEXT = "drops_status_chip_text"
    const val DROPS_CHIP_TIME_REMAINING = "time_remaining"
    const val DROPS_CHIP_PERCENT = "percent"
    const val DROPS_CHIP_DROP = "drop"
    const val CHAT_BUBBLE_ENABLED = "chat_bubble_enabled"
    const val CHAT_BUBBLE_AUTO_EXPAND = "chat_bubble_auto_expand"
    const val CHAT_BUBBLE_SHOW_UNREAD = "chat_bubble_show_unread"
    const val CHAT_BUBBLE_SHOW_PREVIEW = "chat_bubble_show_preview"
    const val CHAT_BUBBLE_KEEP_OPEN = "chat_bubble_keep_open"
    const val CHAT_BUBBLE_NOTIFICATION_SETTINGS = "chat_bubble_notification_settings"
    const val CHAT_BUBBLE_ACTIVE_CHANNEL_ID = "chat_bubble_active_channel_id"
    const val CHAT_BUBBLE_ACTIVE_CHANNEL_LOGIN = "chat_bubble_active_channel_login"
    const val CHAT_BUBBLE_ACTIVE_CHANNEL_NAME = "chat_bubble_active_channel_name"
    const val CHAT_BUBBLE_UNREAD_COUNT = "chat_bubble_unread_count"
    const val PREDICTION_LIVE_UPDATE_SNAPSHOT = "prediction_live_update_snapshot"
    const val PREDICTION_LIVE_UPDATE_RESULT_ID = "prediction_live_update_result_id"
    const val DROPS_LIVE_UPDATE_SNAPSHOT = "drops_live_update_snapshot"
    const val DROPS_LIVE_UPDATE_RESULT_ID = "drops_live_update_result_id"
