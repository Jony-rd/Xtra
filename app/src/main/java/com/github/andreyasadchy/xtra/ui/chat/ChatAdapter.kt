...
/** Shared rendering/callback configuration for the live v2 interaction popouts and replay adapter. */
internal data class ChatAdapterConfiguration(
    val localTwitchEmotes: List<TwitchEmote>,
    val thirdPartyEmotes: List<Emote>,
    val globalBadges: List<TwitchBadge>,
    val channelBadges: List<TwitchBadge>,
    val cheerEmotes: List<CheerEmote>,
    val namePaints: List<NamePaint>,
    val stvBadges: List<STVBadge>,
    val personalEmoteSets: Map<String, List<Emote>>,
    val stvUsers: List<STVUser>,
    val enableTimestamps: Boolean,
    val timestampFormat: String?,
    val firstMsgVisibility: Int,
    val firstChatMsg: String,
    val redeemedChatMsg: String,
    val redeemedNoMsg: String,
    ...
    val emoteSize: Int,
    val badgeSize: Int,
    val inlineIconSize: Int,
    val emoteQuality: String,
    val animateGifs: Boolean,
    val enableOverlayEmotes: Boolean,
    val translateMessage: (ChatMessage, String?) -> Unit,
    val showLanguageDownloadDialog: (ChatMessage, String) -> Unit,
    val channelId: String?,
    val loggedInUser: String?,
    val messageClickListener: ((String?) -> Unit)?,
...
class ChatAdapter(
    ...
    internal constructor(
        initialMessages: List<ChatMessage>,
        configuration: ChatAdapterConfiguration,
    ) : this(
        initialMessages = initialMessages,
        localTwitchEmotes = configuration.localTwitchEmotes,
        thirdPartyEmotes = configuration.thirdPartyEmotes,
        globalBadges = configuration.globalBadges,
        channelBadges = configuration.channelBadges,
        cheerEmotes = configuration.cheerEmotes,
        namePaints = configuration.namePaints,
        stvBadges = configuration.stvBadges,
        personalEmoteSets = configuration.personalEmoteSets,
        stvUsers = configuration.stvUsers,
        enableTimestamps = configuration.enableTimestamps,
        timestampFormat = configuration.timestampFormat,
        firstMsgVisibility = configuration.firstMsgVisibility,
        firstChatMsg = configuration.firstChatMsg,
        redeemedChatMsg = configuration.redeemedChatMsg,
        redeemedNoMsg = configuration.redeemedNoMsg,
        replyMessage = configuration.replyMessage,
        useRandomColors = configuration.useRandomColors,
        useReadableColors = configuration.useReadableColors,
        isLightTheme = configuration.isLightTheme,
        nameDisplay = configuration.nameDisplay,
        useBoldNames = configuration.useBoldNames,
        showNamePaints = configuration.showNamePaints,
        showBadges = configuration.showBadges,
        showSTVBadges = configuration.showSTVBadges,
        showPersonalEmotes = configuration.showPersonalEmotes,
        showSystemMessageEmotes = configuration.showSystemMessageEmotes,
        ...
        emoteSize = configuration.emoteSize,
        badgeSize = configuration.badgeSize,
        inlineIconSize = configuration.inlineIconSize,
        emoteQuality = configuration.emoteQuality,
        animateGifs = configuration.animateGifs,
        enableOverlayEmotes = configuration.enableOverlayEmotes,
        translateMessage = configuration.translateMessage,
        showLanguageDownloadDialog = configuration.showLanguageDownloadDialog,
        channelId = configuration.channelId,
        loggedInUser = configuration.loggedInUser,
        messageClickListener = configuration.messageClickListener,
