...
INTENTIONAL_FALLBACK_RESOURCES = {
    ...
    # Player swipe controls and the preview's native-zone label ship with the
    # default English wording until translations are reviewed by native speakers.
    "settings_native",
    "settings_player_swipe_controls",
    "settings_player_swipe_controls_summary",
    "settings_player_swipe_enabled_summary",
    "settings_player_swipe_left_gesture",
    "settings_player_swipe_right_gesture",
    "settings_player_swipe_top_gesture",
    "settings_player_swipe_off",
    "settings_player_swipe_brightness",
    "settings_player_swipe_volume",
    "settings_player_swipe_speed",
    "settings_player_swipe_edge_width",
    "settings_player_swipe_edge_width_summary",
    "settings_player_swipe_speed_height",
    "settings_player_swipe_speed_height_summary",
    "settings_player_swipe_preview",
    "settings_player_swipe_preview_summary",
    "settings_player_swipe_brightness_sensitivity",
    "settings_player_swipe_brightness_sensitivity_summary",
    "settings_player_swipe_volume_sensitivity",
    "settings_player_swipe_volume_sensitivity_summary",
    "settings_player_swipe_speed_sensitivity",
    "settings_player_swipe_speed_sensitivity_summary",
    "settings_player_swipe_speed_step",
    "settings_player_swipe_ignore_locked",
    "settings_player_swipe_zones_content_description",
    "settings_player_swipe_zone_value",
    "settings_player_swipe_zone_value_single",
